...
export {default as ModalProfile} from './Common/ModalProfile'
export {default as ModalDetail} from './Common/ModalDetail'
export {default as ModalRedux} from './Common/ModalRedux'
